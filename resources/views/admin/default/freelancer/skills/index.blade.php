...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header">
                    <h1 class="mb-0 h6">{{translate('Tags list')}}</h1>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-5">
            <div class="card">
                <div class="card-header">
                    <h1 class="mb-0 h6">{{translate(' Add New Tag')}}</h1>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('skills.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3 text-right">
                            <button type="submit" class="btn btn-primary">{{translate('Add New Tags')}}</button>
                        </div>
                    </form>
                </div> <!-- end card-body -->
            </div> <!-- end card-->
