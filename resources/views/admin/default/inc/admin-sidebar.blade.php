    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                @if(auth()->user()->can('show all projects')
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Task')}}</span>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_projects') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('All Task')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('running_projects') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Running Task')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('open_projects') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Open Task')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('cancelled_projects') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Cancelled Task')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('cancel-project-request.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Task Cancel Request')}}</span>
                                </a>
                            </li>
                            @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('project-categories.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['project-categories.index', 'project-categories.edit', 'project-categories.destroy'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Task Category')}}</span>
                                </a>
                            </li>
                            @endcan
                        </ul>
                ...
                @can('show user chats')
                <li class="aiz-side-nav-item">
                    <a href="{{ route('freelancer_package.index', 'freelancer')  }}" class="aiz-side-nav-link {{ areActiveRoutes(['freelancer_package.index', 'chat_details_for_admin'])}}">
                ...
                @can('show user chats')
                <li class="aiz-side-nav-item">
                    <a href="{{ route('badges.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['badges.index', 'chat_details_for_admin'])}}">
                ...
                <!-- @if(auth()->user()->can('show all freelancers')
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Professionals')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a> -->
                        <!-- <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_freelancers') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_freelancers', 'freelancer_info_show'])}}">
                                    <span class="aiz-side-nav-text">{{translate('All Professionals')}}</span>
                                </a>
                            </li>
                            @endcan -->
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('freelancer_package.index', 'freelancer') }}" class="aiz-side-nav-link {{ areActiveRoutes(['freelancer_package.index', 'freelancer_package.create', 'freelancer_package.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Professionals Packages')}}</span>
                                </a>
                            </li>
                            @endcan -->
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('skills.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['skills.index', 'skills.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Professionals Tags')}}</span>
                                </a>
                            </li>
                            @endcan -->
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('badges.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['badges.index', 'badges.create', 'badges.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Professional Badges')}}</span>
                                </a>
                            </li>
                            @endcan -->
                        <!-- </ul>
                ...
                <!-- @if(auth()->user()->can('show all agents'))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-user-circle aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Agents')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            @can('show all agents')
                            <li class="aiz-side-nav-item">
                                <a href="" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('All Agents')}}</span>
                                </a>
                            </li>
                            @endcan -->
