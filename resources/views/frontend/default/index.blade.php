            ...
            <div class="container">
                <div class="bg-primary py-7 px-6 rounded-2">
                    <div class="lh-1-8 mx-auto mb-5">
                        <h2 class="fw-700 fs-40 text-white" style="text-align: center">{{ get_setting('featured_category_title') }}</h2>
                        <p class="fs-17 text-white" style="text-align: center">{{ get_setting('featured_category_subtitle') }}</p>
                    </div>
