 ...
 <section class="footer-container">
    <div class="footer-inner-container">
        <ul class="footer-nav">
            ...
            style="background: url('{{ asset('public/kemedar') }}/images/FindImage.png') no-repeat 50% 88%/14em , #ededed;"
            onmouseenter="finddropdownshow()" onmouseleave="finddropdownhide()" >
                    ...
                    <ul class="benefit-list" style="margin-top: 10px !important; margin-left: -20px !important;">
                        <li onmouseenter="properSubmenushow()" onmouseleave="properSubmenuhide()">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-01.png" class="img-fluid" alt="">
                            </i>
                            <a href="">
                            ...
                            <div class="inner-submenu" id="properSubmenu" onmouseenter="properSubmenushow()" onmouseleave="properSubmenuhide()">
                                ...
                                <ul>
                                    ...
                                    <li class="brn">
                                            <i >
                                            <img src="{{ asset('public/kemedar') }}/images/property/Icon-01.png" class="img-fluid" alt="">
                                            </i>
                                        <a href="">
                                            <span>For Sale</span>
                                        </a>
                                    ...
                                    <li class="brn">
                                        <i >
                                        <img src="{{ asset('public/kemedar') }}/images/property/Icon-02.png" class="img-fluid" alt="">
                                        </i>
                                    <a href="">
                                ...
                                <li class="brn">
                                    <i >
                                    <img src="{{ asset('public/kemedar') }}/images/property/Icon-04.png" class="img-fluid" alt="">
                                    </i>
                                <a href="">
                                    <span>For Rent</span>
                                </a>
                            ...
                            <li class="brn">
                                <i >
                                <img src="{{ asset('public/kemedar') }}/images/property/Icon-05.png" class="img-fluid" alt="">
                                </i>
                            <a href="">
                        ...
                        onmouseenter="taskerSubmenushow()" onmouseleave="taskerSubmenuhide()">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-02.png" class="img-fluid" alt="">
                            </i>
                        ...
                        <li class="brn">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-03.png" class="img-fluid" alt="">
                            </i>
                            <a href="">
                        ...
                        <li class="">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-04.png" class="img-fluid" alt="">
                            </i>
                            <a href="">
                                <span>Agents</span>
                            </a>
                        ...
                        <li class="">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-05.png" class="img-fluid" alt="">
                            </i>
                            <a href="">
                        ...
                        <li class="brn">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-12.png" class="img-fluid" alt="">
                            </i>
                            <a href="">
                        ...
                        <li class="">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-10.png" class="img-fluid" style="width:20px" alt="">
                            </i>
                        ...
                        <li  style="color:#000 !important;" onmouseenter="productSubmenushow()" onmouseleave="productSubmenuhide()">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-09.png" class="img-fluid" style="width:20px" alt="">
                            </i>
                            ...
                            <div class="product-submenu" id="productSubmenu" onmouseenter="productSubmenushow()" onmouseleave="productSubmenuhide()">
                                <div class="left-div-submenu">
                                    ...
                                    <ul>
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-01.png" alt="">
                                            </i>
                                            <a href="">
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-02.png" alt="">
                                            </i>
                                            <a href="">
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-03.png" alt="">
                                            </i>
                                            <a href="">
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-04.png" alt="">
                                            </i>
                                            <a href="">
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-05.png" alt="">
                                            </i>
                                            <a href="">
                                                <span>Plumbing</span>
                                            </a>
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-06.png" alt="">
                                            </i>
                                            <a href="">
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-07.png" alt="">
                                            </i>
                                            <a href="">
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-08.png" alt="">
                                            </i>
                                            <a href="">
                                                <span>Furniture</span>
                                            </a>
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-09.png" alt="">
                                            </i>
                                            <a href="">
                                        ...
                                        <li>
                                            <i>
                                                <img src="{{ asset('public/kemedar') }}/images/product/Icon-10.png" alt="">
                                            </i>
                                            <a href="">
                                ...
                                <div class="left-right-submenu">
                                    <img src="{{ asset('public/kemedar') }}/images/products.png" width="100%" height="auto" alt="">
                                </div>
                            </div>
                        </li>
                        <li class="brn">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-08.png" class="img-fluid" style="width:20px" alt="">
                            </i>
                        ...
                        <li class="">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-07.png" class="img-fluid" style="width:20px" alt="">
                            </i>
                        ...
                        <li class="">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-06.png" class="img-fluid" style="width:20px" alt="">
                            </i>
                            <a href="hire-technician/carpenter.html">
                        ...
                        <li class="brn" style="color:#000 !important;">
                            <i>
                                <img src="{{ asset('public/kemedar') }}/images/find/Icon-11.png" class="img-fluid" style="width:20px" alt="">
                            </i>
                            <a href="hire-technician/lawyer.html">
            ...
            style="background: url('{{ asset('public/kemedar') }}/images/add.png') no-repeat 50% 88%/23em , #ededed;" >
                <div>
                ...
                margin-left: -20px !important;">
                    <li>
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-01.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Property</span>
                        </a>
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-02.png" class="img-fluid" alt="">
                        </i>
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-03.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Project</span>
                        </a>
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-06.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-07.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Store</span>
                        </a>
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-08.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Product</span>
                        </a>
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-09.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/carpenter.html">
                            <span>Post</span>
                        </a>
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-04.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/lawyer.html">
                            <span>Page</span>
                        </a>
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-05.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/decorist.html">
                            <span>Group</span>
                        </a>
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-11.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/painter.html">
                            <span>Event</span>
                        </a>
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-10.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/carpenter.html">
                    ...
                    <li class="brn" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-12.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/lawyer.html">
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-14.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/lawyer.html">
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/add/Icon-13.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/lawyer.html">
                            <span>Course</span>
                        </a>
            ...
            style="background: url('{{ asset('public/kemedar') }}/images/invest.png') no-repeat 50% 88%/23em , #ededed;" >
                <div>
                ...
                margin-left: -20px !important;">
                    <li>
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-01.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-02.png" class="img-fluid" alt="">
                        </i>
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-03.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-04.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-05.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-06.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-07.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/carpenter.html">
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-08.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/lawyer.html">
                    ...
                    <li class="brn" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/invest/Icon-09.png" class="img-fluid" style="width:20px" alt="">
                        </i>
                        <a href="hire-technician/lawyer.html">
            ...
            style="background: url('{{ asset('public/kemedar') }}/images/CONNCECT.png') no-repeat 50% 88%/23em , #ededed;" >
                <div>
                ...
                margin-left: -20px !important;">
                    <li>
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/connect/Icon-01.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>News Feed</span>
                        </a>
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/connect/Icon-02.png" class="img-fluid" alt="">
                        </i>
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/connect/Icon-03.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Groups</span>
                        </a>
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/connect/Icon-04.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Pages </span>
                        </a>
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/connect/Icon-05.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Forums </span>
                        </a>
            ...
            style="background: url('{{ asset('public/kemedar') }}/images/know.png') no-repeat 50% 88%/23em , #ededed;" >
                <div>
                ...
                margin-left: -20px !important;">
                    <li>
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/know/Icon-01.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/know/Icon-02.png" class="img-fluid" alt="">
                        </i>
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/know/Icon-03.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Reports</span>
                        </a>
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/know/Icon-04.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/know/Icon-05.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/know/Icon-06.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/know/Icon-07.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
            ...
            style="background: url('{{ asset('public/kemedar') }}/images/learn.png') no-repeat 50% 88%/23em , #ededed;" >
                <div>
                ...
                margin-left: -20px !important;">
                    ...
                    <li onmouseenter="hdhDivshow()" onmouseleave="hdhDivhide()" >
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/find/Icon-09.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                        ...
                        <div class="inner-submenu" id="hdhDiv" onmouseenter="hdhDivshow()" onmouseleave="hdhDivhide()">
                            ...
                            <ul>
                                ...
                                <li class="">
                                        <i >
                                        <img src="{{ asset('public/kemedar') }}/images/product/Icon-01.png" class="img-fluid" alt="">
                                        </i>
                                    <a href="">
                                ...
                                <li class="">
                                    <i >
                                    <img src="{{ asset('public/kemedar') }}/images/product/Icon-02.png" class="img-fluid" alt="">
                                    </i>
                                <a href="">
            ...
            onmouseenter="paidservicesDivshow()" onmouseleave="paidservicesDivhide()" style="background: url('{{ asset('public/kemedar') }}/images/paid.png') no-repeat 50% 155%/23em , #ededed;" >
                <div>
                ...
                margin-left: -20px !important;">
                    <li>
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/paid/Icon-01.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/paid/Icon-02.png" class="img-fluid" alt="">
                        </i>
                    ...
                    <li class="brn">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/paid/Icon-03.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="" >
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/paid/Icon-04.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="" >
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/paid/Icon-05.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="brn" >
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/paid/Icon-06.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
            ...
            <ul class="benefit-list" style="margin-top:10px !important; margin-left: -20px;">
                <li>
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-01.png" class="img-fluid" alt="">
                    </i>
                    <a href="">
                ...
                <li class="brn">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-02.png" class="img-fluid" alt="">
                    </i>
                    <a href="">
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-03.png" class="img-fluid" alt="">
                    </i>
                    <a href="">
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-04.png" class="img-fluid" alt="">
                    </i>
                    <a href="">
                ...
                <li class="brn">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-05.png" class="img-fluid" alt="">
                    </i>
                    <a href="">
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-06.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/carpenter.html">
                ...
                <li class="" style="color:#000 !important;">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-07.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/lawyer.html">
                ...
                <li class="brn">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-08.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/decorist.html">
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-18.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/painter.html">
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-11.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/carpenter.html">
                        <span>Investor</span>
                    </a>
                ...
                <li class="brn" style="color:#000 !important;">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-12.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/lawyer.html">
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-13.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/decorist.html">
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-14.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/painter.html">
                ...
                <li class="brn">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-15.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-16.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="">
                ...
                <li class="">
                    <i>
                        <img src="{{ asset('public/kemedar') }}/images/register/Icon-17.png" class="img-fluid" style="width:20px" alt="">
                    </i>
                    <a href="hire-technician/carpenter.html">
            ...
            onmouseenter="appdivshow()" onmouseleave="appdivhide()">
                ...
                <ul class="benefit-list" style="margin-top:20px !important; margin-left: -25px;">
                    <li class="brn" onmouseenter="kemeappDivshow()" onmouseleave="kemeappDivhide()">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/mobile/Icon-01.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Kemedar</span>
                        </a>
                            ...
                            <div style="margin-top: -10px;">
                                    <div class="get-app">
                                        ...
                                        <a href="" style="display: inline !important; padding: 0px !important;">
                                            <img src="{{ asset('public/kemedar') }}/images/google-play.svg" width="75px" alt="">
                                        ...
                                        <a href="" style="display: inline !important; padding: 0px !important;  margin-left: 8px;">
                                            <img src="{{ asset('public/kemedar') }}/images/app-store.svg" width="63px" alt="">
                    ...
                    <li class="brn" onmouseenter="kemetoappDivshow()" onmouseleave="kemetoappDivhide()" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/mobile/Icon-02.png" class="img-fluid" alt="">
                        </i>
                    ...
                    <li class="brn" onmouseenter="kemetroappDivshow()" onmouseleave="kemetroappDivhide()">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/mobile/Icon-03.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                            <span>Kemmetro</span>
                        </a>
                    ...
                    <li class="brn" onmouseenter="kemenewsappDivshow()" onmouseleave="kemenewsappDivhide()">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/mobile/Icon-04.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="brn" onmouseenter="kemeacaappDivshow()" onmouseleave="kemeacaappDivhide()">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/mobile/Icon-05.png" class="img-fluid" alt="">
                        </i>
                        <a href="">
            ...
            <div class="benefit-div find-div frnchdiv " id="franchisediv" onmouseenter="franchisedivshow()" onmouseleave="franchisedivhide()" >
                ...
                <ul class="benefit-list" style="margin-top:20px !important; margin-left: -25px;">
                    <li class="">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/area.jpeg" class="img-fluid" width="20px" height="20px" alt="">
                        </i>
                        <a href="">
                    ...
                    <li class="brn" style="color:#000 !important;">
                        <i>
                            <img src="{{ asset('public/kemedar') }}/images/countrylocation.jpeg" class="img-fluid" alt="" width="20px" height="20px">
                        </i>
