...
<link rel="stylesheet" href="{{ asset('public/kemedar/css/style.css') }}">
        ...
        <div class="top-nav">
            ...
            <div class="left-nav-top">
                <button class="top-btn btn-active" onmouseenter="Kemeshow()" onmouseleave="Kemehide()">
                    <img src="{{ asset('public/kemedar/images/btn1.ico') }}" alt="">
                    <span>Kemedar</span>
                ...
                <button class="top-btn btn2" onmouseenter="ketroshow()" onmouseleave="ketrohide()">
                    <img src="{{ asset('public/kemedar/images/btn2.ico') }}" alt="">
                    <span>Kemmetro</span>
                ...
                <button class="top-btn btn3" onmouseenter="kemetashow()" onmouseleave="kemetahide()">
                    <img src="{{ asset('public/kemedar/images/btn3.ico') }}" alt="">
                    <span>Kemmeta</span>
                ...
                <button class="top-btn btn4" onmouseenter="kemnewsshow()" onmouseleave="kemnewshide()">
                    <img src="{{ asset('public/kemedar/images/btn4.ico') }}" alt="">
                    <span>Kemenews</span>
                ...
                <button class="top-btn btn5" onmouseenter="kemacdshow()" onmouseleave="kemacdhide()">
                    <img src="{{ asset('public/kemedar/images/btn5.ico') }}" alt="">
                ...
                <button class="top-btn btn6" onmouseenter="kemreitshow()" onmouseleave="kemreithide()">
                    <img src="{{ asset('public/kemedar/images/btn6.ico') }}" alt="">
            ...
            <div class="right-nav-top">
                <ul>
                    <li onmouseenter="langugedivshow()" onmouseleave="langugedivhide()">
                        <img src="{{ asset('public/kemedar/images/language.png')  }}" alt="">
                    </li>
                    <li onmouseenter="countryDivshow()" onmouseleave="countryDivhide()">
                        <img src="{{ asset('public/kemedar/images/country.png') }}" alt="">
                    </li>
                    <li onmouseenter="curunceyDivshow()" onmouseleave="curunceyDivhide()">
                        <img src="{{ asset('public/kemedar/images/124.png') }}" alt="">
                    </li>
                    <li onmouseenter="benefitDivshow()" onmouseleave="benefitDivhide()">
                        <img src="{{ asset('public/kemedar/images/user-benefits.png') }}" alt="">
                    </li>
                    <li onmouseenter="aboutDivshow()" onmouseleave="aboutDivhide()">
                        <img src="{{ asset('public/kemedar/images/about-us.png') }}" alt="">
                    </li>
                    <li onmouseenter="contactDivshow()" onmouseleave="contactDivhide()">
                        <img src="{{ asset('public/kemedar/images/call.png') }}" alt="">
                    </li>
                    <li onmouseenter="loginDivshow()" onmouseleave="loginDivhide()">
                        <img src="{{ asset('public/kemedar/images/login.png') }}" alt="">
                    </li>
                    <li onclick="signupmodelDivshow()">
                        <img src="{{ asset('public/kemedar/images/signup.png') }}" alt="">
                    </li>
                </ul>
...
{{--                </div>--}}
                ...
                <div class="country-div" id="countryDiv" onmouseenter="countryDivshow()"
                    ...
                    <div class="country-group-div">
                        ...
                        <ul>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/eg.png') }}" alt="">
                                    <span>Egypt</span>
                                </a>
                            </li>
                            <li class="country-right-li">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/ma.png') }}" alt="">
                                    <span>Morocco</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="country-group-div">
                        ...
                        <ul>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/tr.png') }}" alt="">
                                    <span>Turkey</span>
                                </a>
                            </li>
                            <li class="" style=" margin-left: 65px !important;">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/ru.png') }}" alt="">
                                    <span>Russia</span>
                                </a>
                            </li>
                            <br>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/ua.png') }}" alt="">
                                    <span>Ukraine</span>
                                </a>
                            </li>
                            <li class="" style=" margin-left: 59px !important;">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/de.png') }}" alt="">
                                    <span>Germany</span>
                                </a>
                            </li>
                            <br>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/it.png') }}" alt="">
                                    <span>Italy</span>
                                </a>
                            </li>
                            <li class="" style=" margin-left: 81px !important;">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/es.png') }}" alt="">
                                    <span>Spain</span>
                                </a>
                            </li>
                            <br>
                    ...
                    <div class="country-group-div">
                        ...
                        <ul>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/ae.png') }}" alt="">
                                    <span>UAE</span>
                                </a>
                            </li>
                            <li class="" style=" margin-left: 85px !important;">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/sa.png') }}" alt="">
                            ...
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/id.png') }}" alt="">
                                    <span>Indonesia</span>
                                </a>
                            </li>
                            <li class="" style=" margin-left: 46px !important;">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/vn.png') }}" alt="">
                                    <span>Vietnam</span>
                                </a>
                            </li>
                            <br>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/qa.png') }}" alt="">
                                    <span>Qatar</span>
                                </a>
                            </li>
                            <li class="country-right-li">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/kw.png') }}" alt="">
                                    <span>Kuwait</span>
                                </a>
                            </li>
                            <br>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/om.png') }}" alt="">
                                    <span>Oman</span>
                                </a>
                            </li>
                            <li class="" style=" margin-left: 65px !important;">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/pk.png') }}" alt="">
                                    <span>Pakistan</span>
                                </a>
                            </li>
                            <br>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/bd.png') }}" alt="">
                                    <span>Bangladesh</span>
                                </a>
                            </li>
                            <li class="" style=" margin-left: 31px !important;">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/in.png') }}" alt="">
                                    <span>India</span>
                                </a>
                            </li>
                            <br>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/cn.png') }}" alt="">
                                    <span>China</span>
                                </a>
                            </li>
                            <li class="country-right-li">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/th.png') }}" alt="">
                                    <span>Thailand</span>
                                </a>
                            </li>
                            <br>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/jp.png') }}" alt="">
                                    <span>Japan</span>
                                </a>
                            </li>
                    ...
                    <div class="country-group-div">
                        ...
                        <ul>
                            <li class="">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/us.png') }}" alt="">
                                    <span>USA</span>
                                </a>
                            </li>
                            <li class="" style=" margin-left: 80px !important;">
                                <a href="">
                                    <img src="{{ asset('public/kemedar/images/24/br.png') }}" alt="">
                                    <span>Brazil</span>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="currncy-div" id="curunceyDiv" onmouseenter="curunceyDivshow()"
                    onmouseleave="curunceyDivhide()">
                    <ul id="curncey-menu">
                        <li><a class="curncey-li btn-active" href="">EGP </a></li>
                        <li><a class="curncey-li " href=""> MAD</a></li>
                        <li><a class="curncey-li " href=""> TRY</a></li>
                        <li><a class="curncey-li " href="">RUB </a></li>
                        <li><a class="curncey-li " href="">UAH </a></li>
                        <li><a class="curncey-li " href=""> EUR </a></li>
                        <li><a class="curncey-li " href="">AED </a></li>
                        <li><a class="curncey-li " href="">SAR </a></li>
                        <li><a class="curncey-li " href=""> IDR </a></li>
                        <li><a class="curncey-li " href="">VND </a></li>
                        <li><a class="curncey-li " href="">QAR </a></li>
                        <li><a class="curncey-li " href="">KWD </a></li>
                        <li><a class="curncey-li " href="">OMR</a></li>
                        <li><a class="curncey-li " href="">PKR </a></li>
                        <li><a class="curncey-li " href="">BDT </a></li>
                        <li><a class="curncey-li " href="">INR </a></li>
                        <li><a class="curncey-li " href=""> CNY </a></li>
                        <li><a class="curncey-li " href="">THB </a></li>
                        <li><a class="curncey-li " href="">JPY </a></li>
                        <li><a class="curncey-li " href="">BRL </a></li>
                        <li><a class="curncey-li " href=""> USD</a></li>
                ...
                <div class="login-div" id="loginDiv" onmouseenter="loginDivshow()" onmouseleave="loginDivhide()">
                    ...
                    <div class="input-div">
                        ...
                        <input type="text" class="login-form" placeholder="Please Enter Your Email or Phone Number">
                    </div>
                    <div class="input-div">
                        <label for="" class="input-lable">Password</label>
                        <input type="text" class="login-form" placeholder="Please Enter Your Password">
                    </div>
    ...
    <div class="sidebar-kemedar">
        <ul class="first-menu-sidebar">
            <li>
                <img src="{{ asset('public/kemedar/images') }}/kemepay-iconsvg.svg" alt="" onmouseenter="kempaylogoShow()"
                ...
                <a class="logo-div" href="" id="logoDiv" onmouseenter="kempaylogoToolShow()"
                    ...
                    <img src="{{ asset('public/kemedar/images') }}/kemepay-01.82da9378.ico" alt="">
                </a>
            ...
            <li>
                <img src="{{ asset('public/kemedar/images') }}/kemedar-shiping-iconsvg.svg" alt="" onmouseenter="kemeshipLogoShow()"
                ...
                <a class="logo-div" id="kemeshipLogo" onmouseenter="kemeshipLogoToolShow()"
                    ...
                    <img src="{{ asset('public/kemedar/images') }}/kemeshipping-01.cc608cff.ico" alt="">
                </a>
            ...
            <li>
                <img src="{{ asset('public/kemedar/images') }}/Businessmanager-icon.svg" alt="" onmouseenter="kembusinessLogoShow()"
                ...
                <a class="logo-div" id="kembusinessLogo" onmouseenter="kembusinessLogoToolShow()"
                    ...
                    <img src="{{ asset('public/kemedar/images') }}/Businessmanager01.a2406750.ico" alt="">
                </a>
            ...
            <li>
                <img src="{{ asset('public/kemedar/images') }}/KemedarAds-icon.svg" alt="" onmouseenter="kemadsLogoShow()"
                ...
                <div class="logo-div" id="kemadsLogo" onmouseenter="kemadsLogoToolShow()"
                    ...
                    <img src="{{ asset('public/kemedar/images') }}/Adlogo-01.7e0b6187.ico" alt="">
                </div>
            ...
            <li>
                <img src="{{ asset('public/kemedar/images') }}/KemedarAffiliate-iconsvg.svg" alt="" onmouseenter="affiliateLogoShow()"
                ...
                <div class="logo-div" id="affiliateLogo" onmouseenter="affiliateLogoToolShow()"
                    ...
                    <img src="{{ asset('public/kemedar/images') }}/Affiliatelogo.ico" alt="">
                </div>
                        ...
                        <div class="footer-menu inner-div" id="masubmenu" onmouseenter="masubmenuShow()" onmouseleave="masubmenuHide()" >
                            <ul class="outter-menu">
                                <li onmouseenter="kemAppsubmenuShow()" onmouseleave="kemAppsubmenuHide()">
                                    ...
                                    <div class="app-link">
                                        <a href="">
                                            <img src="{{ asset('public/kemedar/images') }}/google-play.svg"   alt="">

                                        </a>
                                        <span>OR</span>
                                        <a href="">
                                            <img src="{{ asset('public/kemedar/images') }}/app-store.svg" width=" alt="">
                                ...
                                <li onmouseenter="kemetAppsubmenuShow()" onmouseleave="kemetAppsubmenuHide()">
                                    ...
                                    <div class="footer-menu inner-div app-div" id="kemetAppsubmenu" onmouseenter="kemetAppsubmenuShow()" onmouseleave="kemetAppsubmenuHide()" >
                                        ...
                                        <span>OR</span>
                                        <a href="">
                                            <img src="{{ asset('public/kemedar/images') }}/app-store.svg" width="65px" alt="">
...
<script src="{{ asset('public/kemedar/js/app.js') }}"></script>
