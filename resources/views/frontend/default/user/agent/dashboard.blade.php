...
<section class="py-5">
    <div class="container">
        <div class="d-flex align-items-start">
            @include('frontend.default.user.agent.inc.sidebar')
						...
						<div class="row gutters-15">
							<div class="col-md-4">
								<div class="rounded-1 p-4 mb-4 d-flex flex-column justify-content-center" style="min-height: 116px;background: #45b5aa;">
									...
									<div class="h4 fw-700 text-white">{{ single_price(\App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereBetween('updated_at', [Carbon::now()->startOfMonth(), Carbon::now()->endOfMonth()])->sum('agent_profit')) }}</div>
								</div>
								<div class="rounded-1 p-4 bg-dark d-flex flex-column justify-content-center" style="min-height: 116px;background: #45b5aa;">
									...
									<div class="h4 fw-700 text-white">{{ single_price(\App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->sum('agent_profit')) }}</div>
								</div>
							</div>
							<div class="col-md-8">
            ...
            datasets: [
                {
                    ...
                    data: [
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '01')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '02')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '03')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '04')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '05')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '06')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '07')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '08')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '09')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '10')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '11')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }},
                            {{ \App\Models\MilestonePayment::where('paid_status', 1)->where('agent_user_id', Auth::user()->id)->whereMonth('created_at', '=', '12')->whereYear('created_at', '=', date('Y'))->sum('agent_profit') }}
                    ],
