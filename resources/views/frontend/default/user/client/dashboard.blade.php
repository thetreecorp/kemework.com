            ...
            <div class="aiz-user-panel">
            		...
            		<div class="col-md-4 d-flex">
            			<div class="card w-100 rounded-2 bg-hov-soft-primary border-1 border-gray-light">
            				<div class="card-body mt-3">
            					<a href="http://kemework.com/projects/create" class="btn btn-primary btn-block rounded-1 py-3 mb-3">
									<i class="las la-plus fs-40"></i>
									<br>
									<span class="fw-700">{{ translate('Add New Task') }}</span>
								</a>
								<div class="mb-1">
								...
								<div class="mb-1">
									<small class="fs-12 text-secondary">{{ translate('Find & Build your Task with') }}</small>
								</div>
            			...
            			<div class="card w-100 rounded-2 border-gray-light">
            				<div class="card-body mt-3">
            					<div class="mb-4">
									<div class="row">
										<div class="col-8">
											<div class="fs-14">{{ translate('Total Tasks') }}</div>
								...
								<div class="mb-4">
									<div class="row">
										<div class="col-8">
											<div class="fs-14">{{ translate('Completed Task') }}</div>
											@php
												$completedProjects = 0;
								...
								<div class="">
									<div class="row">
										<div class="col-8">
											<div class="fs-14">{{ translate('Running Task') }}</div>
											@php
												$onGoingProjects = 0;
												foreach (Auth::user()->number_of_projects as $key => $project) {
            	...
            	<div class="row gutters-15">
	            	<div class="col-md-4">
	            		<div class="card rounded-2 border-gray-light">
	            			<div class="card-header border-0">
	            				<h6 class="mb-0 fs-16 fw-700">{{ translate('Running Tasks') }}</h6>
	            			</div>
	            	...
	            	<div class="col-md-4">
	            		<div class="card rounded-2 border-gray-light">
	            			<div class="card-header border-0">
	            				<h6 class="mb-0 fs-16 fw-700">{{ translate('Suggested Profesonal') }}</h6>
	            			</div>
	            			<div class="card-body px-0 pt-0">
	            				<div class="aiz-auto-scroll c-scrollbar-light px-4" style="height: 340px; overflow-y: scroll;">
		            				<ul class="list-group list-group-flush">
					...
					<div class="col-md-4">
	            		<div class="card rounded-2 border-gray-light">
	            			<div class="card-header border-0">
	            				<h6 class="mb-0 fs-16 fw-700">{{ translate('Suggested Agency') }}</h6>
	            			</div>
	            			<div class="card-body px-0 pt-0">
	            				<div class="aiz-auto-scroll c-scrollbar-light px-4" style="height: 340px; overflow-y: scroll;">
		            				<ul class="list-group list-group-flush">
		            					@foreach (\App\Models\User::where('user_type', 'agent')->inRandomOrder()->limit(10)->get(); as $key => $user)
											<li class="list-group-item border-0 px-0">
												<a href="{{ route('freelancer.details', $user->user_name) }}" class="text-inherit d-flex align-items-center">
													<span class="avatar avatar-sm flex-shrink-0 bg-soft-primary mr-3">
														@if($user->photo != null)
            		...
            		<div class="col-md-4 d-flex">
            			<div class="card rounded-2 border-gray-light w-100">
            				...
            				<div class="card-body pt-3">
            					...
            					<p class="mb-1 fs-13 pb-2">{{ translate('Remaining Fixed Tasks') }} - <strong>{{ Auth::user()->userPackage->fixed_limit }}</strong></p>
            					<p class="mb-4 fs-13">{{ translate('Remaining Long Term Task') }} - <strong>{{ Auth::user()->userPackage->long_term_limit }}</strong></p>
            				...
            				<div class="card-body pt-0">
            					<ul class="list-unstyled mb-0">
            						<li class=" py-2">
                                        ...
                                        @endif
            							<span>{{ translate('Fixed Tasks') }} - <span class="fw-700">{{ Auth::user()->userPackage->package->fixed_limit }}</span></span>
            						</li>
            						<li class=" py-2">
                                        ...
                                        @endif
            							<span>{{ translate('Long Term Task') }} - <span class="fw-700">{{ Auth::user()->userPackage->package->long_term_limit }}</span></span>
            						</li>
                                    <li class=" py-2">
...
<script type="text/javascript">
    AIZ.plugins.chart('#pie-1',{
        ...
        data: {
            labels: [
				"{{ translate('Total Task') }}",
				"{{ translate('Completed Task') }}",
				"{{ translate('Running Task') }}",
            ],
            datasets: [
                {
