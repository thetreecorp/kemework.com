                ...
                <div class="aiz-user-panel">
                    <div class="aiz-titlebar mb-4">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h1 class="fs-16 fw-700">{{ translate('All Tasks') }}</h1>
                            </div>
							<div class="col-md-6 text-md-right">
								<a href="{{ route('projects.create') }}" class="btn btn-primary rounded-1">
									<i class="las la-plus"></i>
									<span>{{ translate('Add New Task') }}</span>
								</a>
							</div>
                        </div>
                    </div>
								...
								<div class="card-body pt-1">
									...
									<ul class="list-inline opacity-70 fs-12">
										...
										<li class="list-inline-item">
											...
											<span>{{ translate($project->duration . " " . $project->duration_type) }}</span>
										</li>
										{{-- {{App\Models\Country::find('id',$project->city_id)}} --}}
										...
										<i class="las la-map-marker-alt"></i>
                                            ...
                                            @php
                                                $country_name = \App\Models\Country::where('id',$project->country_id)->select('name')->get();
								
												$country_name = substr( $country_name,10,-3);

												$city_name = \App\Models\City::where('id',$project->city_id)->select('name')->get();
								
												$city_name = substr( $city_name,10,-3);
											...
											<span>{{$project->street . ','.$city_name . ',' .$country_name}}</span>
