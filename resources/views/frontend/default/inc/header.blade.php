                                        ...
                                        <select class="form-control aiz-selectpicker  rounded-left-0" name="type">
                                            <option value="freelancer" @isset($type)
                                                @if ($type == 'freelancer')
                                                    selected
                                                @endif
                                            @endisset>{{ translate('Profesonal') }}</option>
                                            <option value="project" @isset($type)
                                                @if ($type == 'project')
                                                    selected
                                                @endif
                                            @endisset>{{ translate('Task') }}</option>
                    ...
                    color: red;
                            ...
                            .hire_image{
                                height: 250px;
                                        ...
                                        <li class="nav-item ml-xl-3" style="list-style-type:none;">
                                            <a class="btn btn-primary rounded-1" href="http://kemework.com/search?keyword=&type=agent">{{ translate(' agent') }}</a>
                                        </li>
                                        </ul> -->
                        ...
                        <div class="menu">
                            <nav class="navbar-expand">
                                <ul class="navbar-nav ml-auto align-items-center">
                                    ...
                                    @elseif (isClient() || isFreelancer() || isAgent())
