							...
							<div class="form-group mb-4">
								<div class="aiz-radio-inline">
									<label class="aiz-radio">
										<input type="radio" name="user_types[]" value="freelancer" @if($type=='freelancer') checked @endif> {{ translate('As A Profesonal') }}
									...
									<label class="aiz-radio">
										<input type="radio" name="user_types[]" value="agent" @if($type=='agent') checked @endif> {{ translate('As An Agent') }}
										<span class="aiz-rounded-check"></span>
									</label>
								</div>
							</div>
