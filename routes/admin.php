...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/professionals-package-index/{type}', 'PackageController@index')->name('freelancer_package.index');
	Route::get('/professionals-package-create/{type}', 'PackageController@create')->name('freelancer_package.create');
	...
	Route::get('/professionals-package-edit/{id}', 'PackageController@edit')->name('freelancer_package.edit');
	...
	Route::get('/all-tasks', 'AdminProjectController@all_projects')->name('all_projects');
	Route::get('/running-tasks', 'AdminProjectController@running_projects')->name('running_projects');
	Route::get('/open-tasks', 'AdminProjectController@open_projects')->name('open_projects');
	Route::get('/cancelled-tasks', 'AdminProjectController@cancelled_projects')->name('cancelled_projects');
	Route::get('/task/destroy/{id}', 'ProjectController@destroy')->name('delete_project_by_admin');
	Route::post('/tasks/approval-status', 'AdminProjectController@project_approval')->name('project_approval');
	...
	Route::get('/all-Professionals', 'UserController@all_freelancers')->name('all_freelancers');
	Route::get('/all-agents', 'UserController@all_agents')->name('all_agents');
	Route::get('/Professionals-info/{user_name}', 'UserController@freelancer_details')->name('freelancer_info_show');
	Route::get('/Professionals-info/{user_name}', 'UserController@freelancer_details')->name('freelancer_info_show');
