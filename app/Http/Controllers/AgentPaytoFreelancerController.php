...
class AgentPaytoFreelancerController extends Controller
{
    ...
    public function send_withdrawal_request_index()
    {
        ...
        return view('frontend.default.user.agent.earnings.withdrawal-make', compact('profile'));
    }
    ...
    public function withdrawal_history_index()
    {
        ...
        return view('frontend.default.user.agent.earnings.withdrawal-history', compact('withdraw_requests'));
    }
