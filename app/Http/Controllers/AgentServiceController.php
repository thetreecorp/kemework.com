...
class AgentServiceController extends Controller
{
    ...
    {
        return view('frontend.default.user.agent.projects.services.index');
    }

    public function freelancer_index()
    {
        $services = Auth::user()->services()->paginate(12);
        return view('frontend.default.user.agent.projects.services.index', compact('services'));
    }
    ...
    public function create()
    {
        if(ServicesUtility::can_create_service() == 1)
            return view('frontend.default.user.agent.projects.services.create');
    ...
    public function edit($slug)
    {
        ...
        return view('frontend.default.user.agent.projects.services.edit', compact('service', 'service_packages'));
    }
    ...
    public function sold_services()
    {
        ...
        return view('frontend.default.user.agent.projects.services.purchased', compact('purchasedServices'));
    }
