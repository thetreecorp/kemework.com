...
class AgentMilestonePaymentController extends Controller
{
    ...
    public function sent_milestone_request_index()
    {
        ...
        return view('frontend.default.user.agent.milestone_payments.index', compact('milestones'));
    }
    ...
    public function recieved_milestone_payment_index()
    {
        ...
        return view('frontend.default.user.agent.earnings.history', compact('milestones'));
    }
