...
class AgentProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.default.user.agent.projects.list', compact('projects'));
    }
    ...
    public function bidded_projects()
    {
        ...
        return view('frontend.default.user.agent.projects.bidded', compact('bidded_projects', 'total_bidded_projects'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.default.user.client.projects.create', compact('categories','skills', 'client_package','country'));
    }
    ...
    public function edit($id)
    {
        ...
        $country = DB::select('select * from countries');
        if ($project->closed == '0') {
            return view('frontend.default.user.client.projects.edit',compact('categories','skills','project','country'));
        }
        else {
